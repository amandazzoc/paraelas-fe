...
export default function Home() {
  return (
  <Flex align="center" justify="center" className={styles.page} vertical gap={5}>
    <Card cover={<img alt="example" src="/cover.jpg" style={{width: "100%"}}/>} style={{ width: "50rem"}}>
      <Flex vertical>
        <Title level={2}>
        ...
        <Flex vertical>
          ...
          <Paragraph style={{marginBottom: 0}}>
            Lembre-se de que <Text strong> a inscrição não garante a vaga; a confirmação da sua participação será feita pela comissão via WhatsApp.</Text>  
          </Paragraph>
          <Paragraph>
